...
fn schema_as_array(generator: &mut SchemaGenerator) -> Schema {
    generator.subschema_for::<Vec<TestResult>>()
}
...
fn parse_rate_schema(generator: &mut SchemaGenerator) -> Schema {
